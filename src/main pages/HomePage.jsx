        ...
        <>
            ...
            <section className='w-full h-[70vh] flex flex-col items-center justify-center'>
                ...
                <div className='w-11/12 h-full gap-3 flex items-center justify-center'>
                    <div className='w-3/4 h-5/6'> <img className='object-cover w-full h-5/6 rounded-md' src={img4} alt="" /><h1 className='text-xl font-bold'>Lakeside Motel Warefront</h1> <p className='text-sm mt-1'>2246 properties</p></div>
                    <div className='w-3/4 h-5/6'> <img className='object-cover w-full h-5/6 rounded-md' src={img5} alt="" /><h1 className='text-xl font-bold'>Recce Graham resort</h1> <p className='text-sm mt-1'>2246 properties</p></div>
                    <div className='w-3/4 h-5/6'> <img className='object-cover w-full h-5/6 rounded-md' src={img6} alt="" /><h1 className='text-xl font-bold'>Fireside Dinners</h1> <p className='text-sm mt-1'>2246 properties</p></div>
                    <div className='w-3/4 h-5/6'> <img className='object-cover w-full h-5/6 rounded-md' src={img7} alt="" /><h1 className='text-xl font-bold'>Oculous Inn Stay</h1> <p className='text-sm mt-1'>2246 properties</p></div>
                </div>
            </section>
            <section className='w-full h-screen flex flex-col items-center justify-center'>
                <div className='w-11/12 h-4/5 bg-cover flex justify-center flex-col relative'>
                    ...
                    <Button className={`z-10 relative w-[300px] h-[50px] ml-10 mt-7`}> Download Mobile App </Button>
                </div>
